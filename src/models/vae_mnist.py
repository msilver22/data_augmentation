...
class Encoder(nn.Module):
    def __init__(self, in_features=784, z_dim=2):
        ...
        self.out1 = nn.Linear(32, z_dim)
        self.out2 = nn.Linear(32, z_dim)
...
class VAE_mnist(L.LightningModule):
    def __init__(
        self,
        z_dim: int = 2,
        lr: float = 0.0001,
    ...
    def on_train_epoch_end(self):
        ...
        if self.current_epoch + 1 in save_epochs:
           torch.save(self.state_dict(), f'./vae/vae_epoch_{self.current_epoch + 1}.pth')
