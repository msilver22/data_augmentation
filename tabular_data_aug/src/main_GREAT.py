...
def main():
    ...
    # Augment the minority class using GReaT
    synthesizer = GReaT(llm='distilgpt2', batch_size=32,  epochs=2000, fp16=True)
    ...
    for i in range(N_RUNS):
        ...
        synthetic_data = synthesizer.sample(n_samples=N_SYNTHETIC_SAMPLES)
